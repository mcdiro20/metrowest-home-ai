...
-- Insert sample data for testing (set your contractor as active subscriber)
UPDATE contractors 
SET is_active_subscriber = true, subscription_tier = 'premium'
WHERE email = (
...
-- Update status column to use enum (optional)
