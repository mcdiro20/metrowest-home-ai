...
-- Update RLS policies to include new fields (admins can manage all contractor data)
-- The existing policies already cover these new columns since they use broad permissions